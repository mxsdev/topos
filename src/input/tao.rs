...
// use crate::{
//     input::{DroppedFile, HoveredFile, Modifiers},
//     util::{FromMinSize, Pos2, Rect, Vec2},
// };

// use super::{clipboard, Event, RawInput};
...
// pub fn screen_size_in_pixels(window: &tao::window::Window) -> Vec2 {
...
//             focused: false, // tao will tell us when we have focus
//             ..Default::default()
//         };
...
//     pub fn take_egui_input(&mut self, window: &tao::window::Window) -> RawInput {
...
//     pub fn on_event(&mut self, event: &tao::event::WindowEvent<'_>) -> EventResponse {
...
//                 self.egui_input
//                     .events
//                     .push(super::input::Event::PointerGone);
//                 EventResponse { repaint: true }
//             }
...
//                 self.egui_input
//                     .events
//                     .push(Event::CompositionText(ime.clone()));

//                 // on Mac even Cmd-C is pressed during ime, a `c` is pushed to Preedit.
//                 // So no need to check is_mac_cmd.
//                 //
//                 // How tao produce `Ime::Enabled` and `Ime::Disabled` differs in MacOS
//                 // and Windows.
//                 //
...
//                 self.egui_input.events.push(Event::WindowFocused(*focused));
//                 EventResponse { repaint: true }
//             }
...
//             | WindowEvent::TouchpadPressure { .. } => EventResponse { repaint: true },

//             // Things we completely ignore:
//             WindowEvent::AxisMotion { .. }
//             | WindowEvent::Moved(_)
//              => EventResponse { repaint: false },

//             WindowEvent::DecorationsClick => EventResponse { repaint: false },

//             _ => EventResponse { repaint: false },
...
//                 tao::event::TouchPhase::Started => TouchPhase::Start,
//                 tao::event::TouchPhase::Moved => TouchPhase::Move,
//                 tao::event::TouchPhase::Ended => TouchPhase::End,
//                 tao::event::TouchPhase::Cancelled => TouchPhase::Cancel,
//                 p => unimplemented!("touch phase '{:?}' not supported", p),
//             },
//             pos: egui::pos2(
...
//         if pressed {
//             // VirtualKeyCode::Paste etc in tao are broken/untrustworthy,
...
// fn is_cut_command(modifiers: egui::Modifiers, keycode: tao::event::VirtualKeyCode) -> bool {
//     (modifiers.command && keycode == tao::event::VirtualKeyCode::X)
//         || (cfg!(target_os = "windows")
//             && modifiers.shift
//             && keycode == tao::event::VirtualKeyCode::Delete)
// }

// fn is_copy_command(modifiers: egui::Modifiers, keycode: tao::event::VirtualKeyCode) -> bool {
//     (modifiers.command && keycode == tao::event::VirtualKeyCode::C)
//         || (cfg!(target_os = "windows")
//             && modifiers.ctrl
//             && keycode == tao::event::VirtualKeyCode::Insert)
// }

// fn is_paste_command(modifiers: egui::Modifiers, keycode: tao::event::VirtualKeyCode) -> bool {
//     (modifiers.command && keycode == tao::event::VirtualKeyCode::V)
//         || (cfg!(target_os = "windows")
//             && modifiers.shift
//             && keycode == tao::event::VirtualKeyCode::Insert)
// }
...
// fn translate_virtual_key_code(key: tao::event::VirtualKeyCode) -> Option<egui::Key> {
//     use egui::Key;
